...
if ([string]::IsNullOrWhiteSpace($TempPassword)) {
    $TempPassword = Read-Host "Enter temporary password for Project 4 pilot users"
}
...
$results | Export-Csv "C:\Users\vm1\Desktop\pilot-users-created-project4.csv" -NoTypeInformation
$results
